        ...
        <>
            ...
            <TransitionPageIn>
                <div className="mx-auto pt-12 md:pt-24">
                    ...
                    <div className="w-10/12 md:w-9/12 mx-auto md:px-8 mb-10 mt-0 md:mt-20">
                        <div className=" md:flex mt-16 md:mt-32 mb-12 md:mb-24 border-b border-gray-400 text-left">
                            <p className="md:w-4/12 line-block flex-1 md:mb-8 md:mx-auto text-lg font-bold uppercase">
                                SpaceX
                            </p>

                            <p className="w-12/12 md:w-7/12 mb-10 mx-auto">
                                <p className=" pt-4 md:mr-10 mb-4">
